...
const GROUP_OF={
  ...
  housing:'housing',houses:'housing',residents:'housing',resident:'housing',intake:'housing',screens:'housing',houselife:'housing',coordination:'housing',employment:'housing',rentrun:'housing',ledger:'housing',orh:'housing',housingoutcomes:'housing',
...
const HOUSING_VIEWS = ['housing','houses','residents','resident','intake','screens','houselife','coordination','employment','rentrun','ledger','orh','housingoutcomes'];
...
const ROLE_MENU = {
  ...
  'Housing Director': ['housing','houses','residents','intake','screens','houselife','coordination','employment','rentrun','ledger','orh','housingoutcomes','mytasks','messages'],
  'House Manager':    ['housing','houses','residents','intake','screens','houselife','coordination','employment','rentrun','ledger','mytasks','messages'],
  'Recovery Coach':   ['housing','residents','intake','screens','houselife','coordination','employment','mytasks','messages'],
};
function flatMenu(){
