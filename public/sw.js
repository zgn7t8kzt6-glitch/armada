...
const C = 'armada-v379';
const SHELL = ['/', '/index.html', '/kiosk.html', '/sl-kiosk.html', '/display.html', '/training.html', '/signup.html', '/styles.css?v=20260707F', '/app.js?v=20260707F', '/logo.png', '/logo.svg', '/manifest.webmanifest'];
