...
const C = 'armada-v390';
const SHELL = ['/', '/index.html', '/kiosk.html', '/sl-kiosk.html', '/display.html', '/training.html', '/signup.html', '/styles.css?v=20260708G', '/app.js?v=20260708G', '/logo.png', '/logo.svg', '/manifest.webmanifest'];
