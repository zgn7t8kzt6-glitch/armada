...
const C = 'armada-v392';
const SHELL = ['/', '/index.html', '/kiosk.html', '/sl-kiosk.html', '/display.html', '/training.html', '/signup.html', '/styles.css?v=20260708I', '/app.js?v=20260708I', '/logo.png', '/logo.svg', '/manifest.webmanifest'];
