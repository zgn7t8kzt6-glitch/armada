...
const GROUP_OF={
  ...
  housing:'housing',houses:'housing',residents:'housing',resident:'housing',intake:'housing',screens:'housing',houselife:'housing',housingstaff:'housing',shiftreports:'housing',hincidents:'housing',coordination:'housing',employment:'housing',rentrun:'housing',ledger:'housing',orh:'housing',housingoutcomes:'housing',
...
const HOUSING_VIEWS = ['housing','houses','residents','resident','intake','screens','houselife','housingstaff','shiftreports','hincidents','coordination','employment','rentrun','ledger','orh','housingoutcomes'];
...
const ROLE_MENU = {
  ...
  'Housing Director': ['housing','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','coordination','employment','rentrun','ledger','orh','housingoutcomes','mytasks','messages'],
  'House Manager':    ['housing','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','coordination','employment','rentrun','ledger','mytasks','messages'],
  'Recovery Coach':   ['housing','residents','intake','screens','houselife','shiftreports','hincidents','coordination','employment','mytasks','messages'],
};
function flatMenu(){
