...
const HOUSING_VIEWS = ['housing','houses','residents','resident','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','rentrun','ledger','orh','housingoutcomes'];
...
const ROLE_MENU = {
  ...
  'Housing Director': ['housing','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','rentrun','ledger','orh','housingoutcomes','mytasks','messages'],
  'House Manager':    ['housing','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','rentrun','ledger','mytasks','messages'],
  'Recovery Coach':   ['housing','residents','intake','screens','houselife','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','mytasks','messages'],
};
function flatMenu(){
