...
export const FORM_TEMPLATES = [
  ...
  { type: 'general_consent', name: 'Day One General Consent', cat: 'Admission', orh: '', sign: true, fields: [
    { k: 'intro', t: 'p', l: 'You just finished a full intake at Armada. We\'re not going to ask you to do another one today. This one page covers what we need to keep you safe and connected until we sit down together to finish your intake. Once you sign, you\'re done with paperwork for the day. Get settled, unpack, and rest.' },
    { k: 'intake_hdr', t: 'p', l: 'Your full intake will be completed within 72 hours of your arrival — by, on, and at:' },
    { k: 'intake_staff', t: 'text', l: 'Full intake — staff name' },
    { k: 'intake_date', t: 'date', l: 'Full intake — date' },
    { k: 'intake_time', t: 'text', l: 'Full intake — time' },
    { k: 'init_armada', t: 'initials', l: '1. Communication with Armada Recovery — I give Hilltop permission to communicate with Armada Recovery (323 S Main St, Unit 301, Akron, OH 44308) regarding my presence and attendance only, until a full release of information is signed at my complete intake.' },
    { k: 'init_transport', t: 'initials', l: '2. Transportation — I give Hilltop permission to transport me between Hilltop locations and destinations I agree to attend, including treatment at Armada, recovery meetings, and errands. I understand that if I choose not to consent to transportation, I am responsible for arranging my own rides through insurance transportation or a licensed ride-share service.' },
    { k: 'init_liability', t: 'initials', l: 'Transportation liability — I agree that if an accident occurs during transport and Hilltop is found not at fault, I will not hold Hilltop civilly liable for that accident.' },
    { k: 'standards', t: 'p', l: 'House Standards for Your First Days — your complete house agreement will be reviewed with you at your full intake. Until then, these are the standards that apply starting tonight:\n• Stabilization period. Your first 14 to 30 days are a stabilization period. During this time you\'ll stay on property unless accompanied by staff or a Hilltop Senior Peer. This exists to protect your early recovery, and it shortens as trust is established. Your intake staff member will explain how.\n• Curfew is 9:00 PM.\n• No mood- or mind-altering substances while you are a resident at Hilltop.\n• Safety comes first. If you become a danger to yourself or others, you cannot remain in the house.\n• Personal property. Hilltop is not responsible for lost or stolen items unless you ask us to secure them in the office.\n• If you need something, ask. Staff will always give you an answer.' },
    { k: 'init_rules', t: 'initials', l: '3. House Standards for Your First Days — I have read the standards above and they apply starting tonight.' },
    { k: 'init_po', t: 'initials', l: '4. Probation/Parole Communication — I give Hilltop permission to contact my probation or parole officer with updates as needed. (Initial, or write N/A if this doesn\'t apply.)' },
    { k: 'po_name', t: 'text', l: 'Officer\'s name' },
    { k: 'po_phone', t: 'text', l: 'Phone' },
    { k: 'po_email', t: 'text', l: 'Email (if applicable)' },
    { k: 'po_county', t: 'text', l: 'County' },
    { k: 'init_lease', t: 'initials', l: '5. Your Address and Lease — the address below is my residence for mail and deliveries. My lease agreement will be prepared around this address and reviewed with me at my full intake.' },
    { k: 'lease_address', t: 'text', l: 'Address' },
    { k: 'outro', t: 'p', l: 'Welcome home. We\'re glad you\'re here.' },
  ] },
