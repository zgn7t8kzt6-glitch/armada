...
const GROUP_OF={
  ...
  housing:'housing',staffhub:'housing',houses:'housing',residents:'housing',resident:'housing',intake:'housing',screens:'housing',houselife:'housing',housingstaff:'housing',shiftreports:'housing',hincidents:'housing',voice:'housing',hmaint:'housing',activities:'housing',movement:'housing',coordination:'housing',employment:'housing',rentrun:'housing',ledger:'housing',orh:'housing',housingoutcomes:'housing',
...
const HOUSING_VIEWS = ['housing','staffhub','houses','residents','resident','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','rentrun','ledger','orh','housingoutcomes'];
...
const ROLE_MENU = {
  ...
  'Housing Director': ['housing','staffhub','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','rentrun','ledger','orh','housingoutcomes','mytasks','messages'],
  'House Manager':    ['housing','staffhub','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','rentrun','ledger','mytasks','messages'],
  'Recovery Coach':   ['staffhub','housing','residents','intake','screens','houselife','shiftreports','hincidents','voice','hmaint','activities','movement','coordination','employment','mytasks','messages'],
};
function flatMenu(){
