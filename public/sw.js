...
const C = 'armada-v250';
const SHELL = ['/', '/index.html', '/kiosk.html', '/sl-kiosk.html', '/display.html', '/training.html', '/signup.html', '/styles.css?v=20260624R', '/app.js?v=20260624R', '/logo.png', '/logo.svg', '/manifest.webmanifest'];
