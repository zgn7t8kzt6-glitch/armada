...
const FAC_SCOPED_API=/^\/(clients($|[?/]\d)|dashboard|arrivals|incidents($|\?)|billingready($|\?|\/run)|appts($|\?)|inventory($|\?)|maintenance($|\?)|requests($|\?|\/count)|command\/overview|retention|opscenter|diag\/admits|outpatient($|\?|\/(analytics|php-outcomes|group-attendance|refresh))|housing\/)/;
