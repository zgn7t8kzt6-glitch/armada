...
const HOUSING_VIEWS = ['housing','houses','residents','resident','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','movement','coordination','employment','rentrun','ledger','orh','housingoutcomes'];
...
const ROLE_MENU = {
  ...
  'Housing Director': ['housing','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','movement','coordination','employment','rentrun','ledger','orh','housingoutcomes','mytasks','messages'],
  'House Manager':    ['housing','houses','residents','intake','screens','houselife','housingstaff','shiftreports','hincidents','voice','hmaint','movement','coordination','employment','rentrun','ledger','mytasks','messages'],
  'Recovery Coach':   ['housing','residents','intake','screens','houselife','shiftreports','hincidents','voice','hmaint','movement','coordination','employment','mytasks','messages'],
};
function flatMenu(){
...
function show(v){
  ...
  const noNavTitles={journey:'Client 360',editor:'Care Card',analytics:'Risk Analytics',scorecard:'Scorecard',accountability:'Accountability','report-view':'Reports',surveys:'Surveys',incidents:'Incidents',partners:'Partners',coverage:'Coverage',assign:'Assign Staff',standard:'The Standard',lineup:'Daily Lineup',dignity:'Dignity Kits',family:'Family',askai:'Ask AI',housing:'Hilltop Recovery Home — HQ',houses:'Houses & Beds',residents:'Residents',resident:'Resident 360',screens:'Drug Screening',houselife:'House Life',coordination:'Clinical Coordination',ledger:'Rent & Funding',orh:'ORH Compliance',housingoutcomes:'Housing Outcomes',intake:'Intake & Forms',rentrun:'Rent Run',employment:'Employment & Job Search',housingstaff:'Staffing',shiftreports:'Shift Reports',hincidents:'Incident Reports',voice:'Resident Voice & Kiosk',hmaint:'Maintenance & Supplies',movement:'Daily Movement'};
